...
call_string_cpp		= PATH + "/data_acq/lora/lora_gateway";
call_string_python	= " | python "+ PATH +"/data_acq/lora/post_processing_gw.py";
call_string_log_gw	= "";
...
def start_config_from_json() :
	...
	gateway_json_array = api.conf_read();
	...
	try:			
		if gateway_json_array["gateway_conf"]["log_post_processing"]:
			call_string_log_gw = " | python "+ PATH +"/data_acq/log_gw.py";
	except KeyError:
		pass
